...
class SessionManager:
    ...
    @classmethod
    def get_storage(cls, config: Optional[SessionStorageConfig] = None) -> ISessionStorage:
        if cls._instance is None:
            cls._instance = cls.create_storage(config)
        return cls._instance

    @classmethod
    def create_storage(cls, config: Optional[SessionStorageConfig] = None) -> ISessionStorage:
