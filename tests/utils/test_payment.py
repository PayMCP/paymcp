...
class TestNormalizeStatus:
    ...
    def test_normalize_paid_statuses(self):
        ...
        paid_statuses = [
            'paid', 'PAID', 'complete', 'completed', 'COMPLETED',
            'succeeded', 'success', 'captured', 'CAPTURED',
    ...
    def test_normalize_canceled_statuses(self):
        ...
        canceled_statuses = [
            'canceled', 'cancelled', 'CANCELLED', 'failed', 'FAILED',
    ...
    def test_normalize_pending_statuses(self):
        ...
        pending_statuses = [
            ...
            'waiting', 'WAITING', 'initiated', 'INITIATED',
            'unknown', 'some-random-status', ''
        ]
